# Contributing to Symba engine

Use https://github.com/syntel-technologies/symba. Branch from `dev` and open a focused PR back to `dev`. Describe the problem, changed behavior, compatibility impact and validation. Use a Conventional Commit title (`feat:`, `fix:`, `docs:`, `ci:`); mark breaking changes with `!` and explain the migration.
